...
$('nav .nav_down').mouseenter(function () {
    ...
    $(this).children('img').attr('src', 'http://localhost:8089/Videos/img/nav_down2.png');
});
$('nav .nav_down').mouseleave(function () {
    $('#nav_down').stop().slideUp();
    $(this).children('img').attr('src', 'http://localhost:8089/Videos/img/nav_down.png');
});
...
//         // alert(params);
//         // post要小写
//         $.post("../login/admin.do",params,function(data){
//         // alert(data);
//                  if(data=='success'){
//
//                       //登录框消失
