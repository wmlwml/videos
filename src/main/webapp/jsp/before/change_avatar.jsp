        ...
        <menu>
            <div class="container clearfix">
                <ul class="clearfix f_left">
                    ...
                    <li><a href="#">关于我们</a></li>
                    <li class="menu_active"><a href="/videos/user/showMyProfile.do">个人中心</a></li>
                </ul>
                <div id="search_group">
        ...
        <div class="container">
            ...
            <div id="profile_tab">
                <ul class="profile_tab_header f_left clearfix">
                    <li><a href="/videos/user/changeProfile.do">更改资料</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="/videos/user/changeAvatar.do">更改头像</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="/videos/user/passwordSafe.do">密码安全</a></li>
                </ul>
                <div class="proflle_tab_body">
                    <h3><a href="/videos/user/showMyProfile.do">返回个人中心</a></h3>
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                            ...
                            <c:if test="${not empty user.imgUrl}">
                                  <img width="200px" height="200px" src="${pageContext.request.contextPath}/upload/${user.imgUrl}">
                            </c:if>
                        ...
                        <div class="profile_ifo_area">
                            <form id="upload_form" enctype="multipart/form-data" method="post" action="/videos/user/upLoadImage.do" >
                                <!-- hidden crop params -->
                                ...
                                <p>第一步：请选择图像文件</p>
                                <div><input type="file" name="upfile" id="image_file" onchange="fileSelectHandler()" /></div>
