        ...
        <menu>
            <div class="container clearfix">
                <ul class="clearfix f_left">
                    ...
                    <li><a href="#">关于我们</a></li>
                    <li class="menu_active"><a href="${pageContext.request.contextPath}/user/showMyProfile.do">个人中心</a></li>
                </ul>
                <div id="search_group">
                ...
                <div id="user_bar">
                    <a href="${pageContext.request.contextPath}/user/showMyProfile.do">
                      <c:if test="${empty user.imgUrl}">
                         <img id="avatar" src="${pageContext.request.contextPath}/img/avatar_lg.png" alt="">
                      </c:if>
                      
                      <c:if test="${not empty user.imgUrl}">
                         <img id="avatar" src="${pageContext.request.contextPath}/upload/${user.imgUrl}" alt="">
                      </c:if>
                       
                    </a>
                    <a href="${pageContext.request.contextPath}/user/loginOutUser.do" id="lay_out">退出</a>
                </div>
            </div>
        </menu>
    </header>
        ...
        <div class="container">
            ...
            <div id="profile_tab">
                <ul class="profile_tab_header f_left clearfix">
                    <li><a href="${pageContext.request.contextPath}/user/changeProfile.do">更改资料</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="${pageContext.request.contextPath}/user/changeAvatar.do">更改头像</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="${pageContext.request.contextPath}/user/passwordSafe.do">密码安全</a></li>
                </ul>
                <div class="proflle_tab_body">
                    <h3><a href="${pageContext.request.contextPath}/user/showMyProfile.do">返回个人中心</a></h3>
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                            <img width="180px" height="180px"  src="${pageContext.request.contextPath}/upload/${user.imgUrl}">
                        </div>
                        <div class="profile_ifo_area">
                            <!--http://localhost/video/user/changeProfile-->
                            <form action="/videos/user/updateUser.do">
                                ...
                                <div class="form_submit dd">
                                    ...
                                    <a href="/videos/user/changeProfile.do">重置</a>
                                </div>
                            </form>
                        </div>
                    </div>
