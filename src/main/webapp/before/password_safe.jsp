                    ...
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                           ...
                           <c:if test="${empty user.imgUrl}">
		                      ...
		                      <c:if test="${not empty user.imgUrl}">
		                         <img id="avatar" width="180px" height="180px" src="${pageContext.request.contextPath}/upload/${user.imgUrl}" alt="">
		                      </c:if>
                        ...
                        <div class="profile_ifo_area">
                            <form action="">
                                ...
                                <div class="form_submit dd">
                                    <button type="button" class="updatePwd">提交更改</button>
                                    <a href="/videos/user/showMyProfile.do">取消</a>
                                </div>
                            </form>
                        </div>
                    </div>
...
<script>
    $(".updatePwd").click(function() {
        ...
        $.get("/videos/user/updatePassword.do",{password: newPassword},function(data) {
