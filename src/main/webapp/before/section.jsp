...
<head>
    ...
    $(function(){
        ...
        $.post("/video/updatePlayNum.do",params);
     });
    </script>
</head>
...
<body class="w100">
    ...
    <nav class="w100">
        <div class="container">
            <img src="${pageContext.request.contextPath}/img/logo.png" alt="Y先生教育的logo" onclick="location.href='jsp/before/index.jsp'" draggable="false">
                ...
                <div class="container">
                    ...
                    <c:forEach items="${course.videoList}" var="video" >
	                    <div class="chapter"  onclick="load(${video.id})">
	                        <p class="biaoti"><a href="/videos/showVideo.do?videoId=${video.id}&subjectName=${subjectName}">${video.title}</a></p>
...
<%-- 
    ...
    <script type="text/javascript">
	    $("#loginout2").click(function(){
	        ...
	        $.get("/videos/user/loginOutUser.do",null,function(){
	             /* $("#regBlock").css("display","block");
	             $("#userBlock").css("display","none"); */
